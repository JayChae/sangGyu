...
- [ ] **약력 한국어 번역 확인** — `public/cv/ko.html` 과 전시 페이지(`ko.html`)의
      약력은 작가가 보낸 영문 PDF(`../sangyu/arts/작가약력.pdf`)를 옮긴 것.
      기관명 표기(중앙미술학원, 판샤오탕 장학금, 타오시촨 미술관, 주중한국문화원
      등)와 전시 제목(영문 그대로 둠)을 작가에게 확인받을 것.
